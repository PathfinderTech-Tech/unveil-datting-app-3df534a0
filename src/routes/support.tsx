...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: "When do photos and full profiles unlock?", a: "Photos and full profiles unlock after both members exchange at least 10 messages and at least one voice note. Real conversation comes before full visibility. After that milestone, you can also begin the journey toward exchanging phone, email, or social handles. Premium members and Daily Pass holders can fast-track contact exchange." },
