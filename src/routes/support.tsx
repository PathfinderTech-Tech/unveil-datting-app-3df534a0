...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: "What is the 7-Day Reveal Journey?", a: "Premium matches unlock progressively over seven days — voice on day 1, personality blueprint on day 2, photos on day 7 — so connection forms before appearance does." },
