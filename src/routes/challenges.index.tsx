...
export const Route = createFileRoute("/challenges/")({
  ...
  errorComponent: ({ error }) => (
    <RouteErrorScreen
      ...
      message="A challenge screen failed, but it should not block the rest of UNVEIL."
      error={error}
    />
  ),
      ...
      return (
        <div className="min-h-screen">
          ...
          <LoadingTimeoutScreen
            title="Challenges are taking longer than expected"
            message="UNVEIL did not finish loading challenge access in time."
          />
        </div>
      );
    }
